...
That runs the demo via Nx (`nx dev @maxigarcia/theme-transitions-app` → `astro dev`). The site is usually available at `http://localhost:4321`.
...
npm run preview -w @maxigarcia/theme-transitions-app
```
